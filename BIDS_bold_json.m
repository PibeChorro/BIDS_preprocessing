%% Matlab script to create an BIDS compatible _bold.json file
% Writing json files relies on the JSONio library
% https://github.com/gllmflndn/JSONio
% Make sure it is in the matab/octave path
%
% Adapted from the BIDS-starter kit script "createBIDS_bold_json_full" by
% DHermes, 2017
% modified RG 201809
...
bold_json.MagneticFieldStrength = hdr{1}.MagneticFieldStrength;
