...
function BIDS_dataset_json(rawdir)
...
dd_json.Name = 'TMS-fMRI-WM2'; % name of the dataset
...
dd_json.Authors = {'Dr. Pablo Grassi', 'Prof. Dr. Andreas Bartels'}; % List of individuals who contributed to the
