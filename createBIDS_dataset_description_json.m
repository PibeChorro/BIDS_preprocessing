function createBIDS_dataset_description_json (root_dir)
%% Matlab script to create an BIDS compatible dataset_description.json file
% The file was adapted from the bids-starterkit 
...
% DHermes, 2017
% modified RG 201809
% modified by Vincent Plikat 02/2021

%%
dataset_description_json_name = fullfile(root_dir, 'dataset_description.json');
...
dd_json.Acknowledgements = {'Dr. Michael Bannert','Jasper Bischoffberger'}; % who should be acknowledge in helping to collect the data
